...
export const M = {
  ...
  agreements: {
    readForm: new Mapping("q143_typeA143", acceptedParser, isString),
    askedQuestions: new Mapping("q144_typeA144", acceptedParser, isString),
    acurateAndTruthful: new Mapping("q145_typeA145", acceptedParser, isString),
    backgroundCheck: new Mapping("q146_typeA146", acceptedParser, isString),
    voluntaryParticipation: new Mapping(
      "q147_typeA147",
      acceptedParser,
      isString,
    ),
    termsAndConditions: new Mapping("q150_typeA150", acceptedParser, isString),
    privacyPolicy: new Mapping("q152_typeA152", acceptedParser, isString),
    tcpa: new Mapping("q148_typeA148", acceptedParser, isString),
  },
