...
VALUES
    (1, 'primary', 1, 'Alex', 'Bregan', '', '', '1705 17th St', '#200', 'Denver', 'CO', '80202'),
    (2, 'primary', 2, 'Jarren', 'Duran', '', '', '1705 17th St', '#200', 'Denver', 'CO', '80202');
...
VALUES
    ...
    (3, 2, 'Carlos', 'Narvaez', 800, 600, 'Approved', TRUE);
...
VALUES
    (1, 'Family, Friend, Neighbor', 'Family', 'Friend Neighbor', '', '', '1705 17th St', '#200', 'Denver', 'CO', '80202', 'en', 'Approved', 'ffn', TRUE, 'youtube.com/watch?v=zk-2_Z9bRds', 'No'),
    ...
    (3, 'LHB', 'Licenced', 'Home Based', '', '', '1705 17th St', '#200', 'Denver', 'CO', '80202', 'en', 'Approved', 'lhb', TRUE, 'https://youtu.be/VTUG-wrriaM?feature=shared', 'No');
